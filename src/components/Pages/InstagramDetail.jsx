...
export default function PortfolioDetailsPage() {
  ...
  pageTitle('Instagram  Marketing Course');
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
  return (
      ...
      <Div className="container">
        ...
        <Div className="row">
          <Div className="col-lg-6">
            ...
            >
              <Spacing lg='40' md='20'/>
              <p>Discover the art of visual storytelling on Instagram. Dive into Instagram's dynamic
ecosystem, explore creative content strategies, and master the use of hashtags and
influencers. Our Instagram Marketing Course includes:</p>
              <Spacing lg='10' md='10'/>
          ...
          <Div className="col-lg-5 offset-lg-1">
            ...
            <Div className="row">
              <Div className="col-6">
                ...
                <p className='cs-m0'>Strategies for growing your Instagram followers</p>
                <Spacing lg='30' md='30'/>
              </Div>
              <Div className="col-6">
                {/* <h3 className='cs-accent_color cs-font_22 cs-font_18_sm cs-m0'>Location:</h3> */}
                <p className='cs-m0'>Creating eye-catching visuals and stories</p>
                <Spacing lg='30' md='30'/>
              </Div>
              <Div className="col-6">
                {/* <h3 className='cs-accent_color cs-font_22 cs-font_18_sm cs-m0'>Software:</h3> */}
                <p className='cs-m0'>Utilizing Instagram's advertising features effectively</p>
                <Spacing lg='30' md='30'/>
              </Div>
